...
#define RESET_ACTIVE() 	HAL_GPIO_WritePin(GPIOA, LCD_RESET_Pin,GPIO_PIN_RESET)
#define RESET_IDLE() 	HAL_GPIO_WritePin(GPIOA,LCD_RESET_Pin,GPIO_PIN_SET)
...
#define DC_COMMAND() 	HAL_GPIO_WritePin(GPIOA,LCD_DC_Pin,GPIO_PIN_RESET)
#define DC_DATA() 		HAL_GPIO_WritePin(GPIOA,LCD_DC_Pin,GPIO_PIN_SET)
